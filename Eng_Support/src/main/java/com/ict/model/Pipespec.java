...
public class Pipespec {
	...
	public double calRe(String phase, double den_liq, double vis_liq , double flow_liq,
				 		double den_vap, double vis_vap, double flow_vap, double vel, double dia) {
		double re = 0;
		double den_avg, vel_avg, vis_avg; 
		
		
		switch (phase) {
			case "liquid": re = den_liq * vel * dia  / (vis_liq / 1000) ;break;
			case "vapor": re = den_vap * vel * dia / (vis_vap / 1000) ;break;
			case "2phase": 
