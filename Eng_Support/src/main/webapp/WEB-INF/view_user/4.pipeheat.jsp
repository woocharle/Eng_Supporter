				...
				<table id="pheat2">
					...
					<tbody>
						...
						<tr> 
							...
							<td><input type="text" name="depth${n.idx}" value="${n.depth}"  <c:if test="${n.ev eq 'buried'}"> disabled="disabled" </c:if>> </td>
						...
						<tr> 
							...
							<td><input type="text" name="soil${n.idx}" value="${n.soil}"<c:if test="${n.ev eq 'buried'}"> disabled="disabled" </c:if>> </td>
						...
						<tr> 
							...
							<td style="font-size: 18px;" >inch</td>
							<td><input type="text" name="heat_dia${n.idx}" value="${n.heat_dia}" <c:if test="${n.ev eq 'buried'}"> disabled="disabled" </c:if>> </td>
						</tr>
				...
				<table id="pheat5">
					<tbody>
						...
						<tr>
							...
							<td>kcal/m<sup>2</sup> h &deg;C</td>
							<td><input type="text" name="out_coeff${n.idx}" value="${n.out_coeff}" ></td>
							<td>Soil Coefficient</td>
							<td>kcal/m<sup>2</sup> h &deg;C</td>
							<td><input type="text" name="soil_coeff${n.idx}" value="${n.soil_coeff}" ></td>
						...
						<tr>
							...
							<td>&nbsp;- by convection</td>
							<td>kcal/m<sup>2</sup> h &deg;C</td>
							<td><input type="text" name="in_coeff_1${n.idx}" value="${n.in_coeff_1}" ></td>
							<td>Diff Temperature</td>
							<td>&deg;C</td>
							<td><input type="text" name="diff_temp${n.idx}" value="${n.diff_temp}" ></td>
						...
						<tr>
							...
							<td>&nbsp;- by radiation</td>
							<td>kcal/m<sup>2</sup> h &deg;C</td>
							<td><input type="text" name="in_coeff_2${n.idx}" value="${n.in_coeff_2}" ></td>
							<td>Ground Temperature</td>
							<td>F</td>
							<td><input type="text" name="g_temp${n.idx}" value="${n.g_temp}" ></td>
						</tr>
