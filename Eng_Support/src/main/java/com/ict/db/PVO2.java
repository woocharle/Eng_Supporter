...
public class PVO2 {
	...
	public PVO2(String idx, String lineno, String pin, String pout, String temp, String den, String vis, String flow,
			...
			String eqvlen, String elbow90_1, String elbow90_2, String elbow90_3, String elbow90_4, String elbow90_5,
			String elbow90_6, String elbow90_7, String elbow90_8, String elbow90_9, String elbow45_1, String elbow45_2,
			String bend_1, String bend_2, String bend_3, String tee_1, String tee_2, String tee_3, String tee_4,
			String tee_5, String tee_6, String tee_7, String tee_8, String gtvalve, String gbvalve, String bvalve,
			String cvalve_1, String cvalve_2, String avalve_1, String avalve_2, String pvalve_1, String pvalve_2,
			String pvalve_3, String dvalve, String redd, String redth, String expd, String expth, List<String> size,
			List<String> schedule, String reynold, String mol, String cmpz, String cpcv) {
		super();
		this.idx = idx;
		this.lineno = lineno;
		this.pin = pin;
