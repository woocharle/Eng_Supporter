...
public class MVO {
	String idx, m_name, m_com, m_phone, m_email, m_id, m_pw, m_content, req_del, req_find;
	
	public MVO() {}

	public MVO(String idx, String m_name, String m_com, String m_phone, String m_email, String m_id, String m_pw,
