...
public class PSV_Controller {
	...
	public ModelAndView pumpadd1_Cmd(HttpServletRequest request) {
		...
		//input
		psv.setItem1(request.getParameter("item1"));
		psv.setRev(request.getParameter("rev"));
		psv.setItem2(request.getParameter("item2"));
		psv.setItem3(request.getParameter("item3"));
		psv.setSetpress(request.getParameter("setpress"));
		psv.setOp(request.getParameter("op"));
		psv.setLimitdp(request.getParameter("limitdp"));
		...
		psv.setPsuc(request.getParameter("psuc"));
		psv.setPdis(request.getParameter("pdis"));
	...
	@RequestMapping(value="psvlinedel1.do")
	public ModelAndView psvlinedel1_Cmd(HttpServletRequest request) {
		ModelAndView mv = new ModelAndView();
		PVO1 psv = new PVO1();
	...
	@RequestMapping(value="psvlineadd2.do", method=RequestMethod.POST)
	...
	@RequestMapping(value="psvlinedel2.do")
	public ModelAndView psvlinedel2_Cmd(HttpServletRequest request) {
		ModelAndView mv = new ModelAndView();
		PVO1 psv = new PVO1();
	...
	@RequestMapping(value="psvrev.do", method=RequestMethod.POST)
