...
<head>
	...
	<style type="text/css">
		...
		#pheat3{position: relative; left: 50px; margin-bottom: 10px; width:1680px;}	
			...
			<!--<form method="post">  -->
				...
				<div id="pheat">
					<table id="pheat1">
						...
						<tbody>
							...
							<tr> <!-- 2 -->
								...
								<td><!-- Over Design: --></td>
								<td>
									<%-- <input type="text" name="over${n.idx}" style="width: 100px; font-size:20px;" value="${n.over}" > --%>
								</td>
								<td></td>
							</tr>	
						</tbody>
					...
					<table id="pheat2">
						<thead>
							<tr>
								<th style="width: 10%;"></th><th style="width: 7%;"></th><th style="width: 7%;"></th><th  style="width: 7%;"></th><th style="width: 9%;"></th><th></th><th style="width: 7%;"></th>
						...
						<tbody>
							...
							<tr> <!-- 4 -->
								...
								<td style="text-align: center;">
									<input type="text" name="over${n.idx}" value="${n.over}" >
									<%-- <input type="text" name="vapor_fr${n.idx}" value="${n.vapor_fr}" <c:if test="${n.phase ne '2phase'}">disabled </c:if>>  --%>
								</td>
							...
							<tr> 
								...
								<td style="font-size: 18px;"><!-- kg/h --></td>
								<td style="text-align: center;">
									<%-- <input type="text" name="flow_liq${n.idx}" value="${n.flow_liq}" <c:if test="${n.phase eq 'vapor'}">disabled </c:if>>  --%>
								</td>
								<td colspan="4">
							...
							<tr> 
								...
								<td style="font-size: 18px;"><!-- kg/h --></td>
								<td style="text-align: center;">
									<%-- <input type="text" name="flow_vapor${n.idx}" value="${n.flow_vapor}" <c:if test="${n.phase eq 'liquid'}">disabled </c:if>>  --%>
								</td>
