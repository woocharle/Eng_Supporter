	...
	<div class="intro">
		...
		<h4>PSV Specification</h4>
			...
			<table id="pspec">
				...
				<tbody>
					<tr>
						<td>Item No.</td><td><input type="text" name="item1" value="${pvo1.item1}" class="pspec1"  onkeyup="rev_go(this.form)"></td><td></td>
						<td>Net Suction Press</td><td><input type="text" name="psuc" value="${pvo1.psuc}" class="pspec2"  readonly> </td><td>kg/cm2</td>
					</tr>
					<tr>
						<td>Rev No.</td><td><input type="text" name="rev"  value="${pvo1.rev}" class="pspec1" onkeyup="rev_go(this.form)"></td><td></td>
						<td>NPSH Available</td><td><input type="number" name="npsh" value="${pvo1.npsh}" class="pspec2" readonly> </td><td>kg/cm2</td>
					</tr>
					<tr>
						<td>Component.</td><td><input type="text" name="comp" class="pspec1" value="${pvo1.comp}" onkeyup="rev_go(this.form)"></td><td></td>
						<td>Discharge Press</td><td><input type="text" name="pdis" class="pspec2" value="${pvo1.pdis}" readonly> </td><td>kg/cm2</td>
					</tr>
					<tr>
						<td>Type.</td>
						<td>
							<select name="ptype" id="combo1" onchange="rev_go(this.form)">
					...
					<tr>
						<td>Condition</td>
						<td>
							<input type="radio" id="Inlet"name="cdtn" value="Inlet" onclick="rev_go(this.form)" checked> 
							<label for="Exist">Exist</label>
							<input type="radio" id="Outlet" name="cdtn" value="Outlet" onclick="rev_go(this.form)">
		...
		<h4>Basis</h4>
			...
			<table id="pbasis1">
				<thead>
						...
						<td style="width:200px;"><input type="text" name="item2" class="pspec1" value="${pvo1.item2}" onkeyup="rev_go(this.form)"></td>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="number" name="op1" class="pspec1" value="${pvo1.op1}" onkeyup="rev_go(this.form)">&nbsp;&nbsp;&nbsp;kg/cm2G</td><td></td>
						<td>Min.Static Head</td><td><input type="number" name="minh" class="pspec2" value="${pvo1.minh}" onkeyup="rev_go(this.form)"></td><td>m</td>
					</tr>
					<tr>
						<td>Design press</td>
						<td><input type="number" name="dp1" class="pspec1" value="${pvo1.dp1}" onkeyup="rev_go(this.form)">&nbsp;&nbsp;&nbsp;kg/cm2G</td><td></td>
						<td>Max.Static Head</td><td><input type="number" name="maxh" class="pspec2" value="${pvo1.maxh}" onkeyup="rev_go(this.form)"></td><td>m</td>
					</tr>
					<tr>
						<td>Strainer</td>
						<td><input type="number" name="strainer" class="pspec1" value="${pvo1.strainer}" onkeyup="rev_go(this.form)">&nbsp;&nbsp;&nbsp;kg/cm2G</td><td></td>
						<td>Pump Shaft Level</td><td><input type="number" name="plevel" class="pspec2" value="${pvo1.plevel}" onkeyup="rev_go(this.form)"> </td><td>m</td>
					</tr>
					<tr>
						<td>Vapor Pressure</td><td><input type="number" name="vppress" class="pspec1" value="${pvo1.vppress}" onkeyup="rev_go(this.form)">&nbsp;&nbsp;&nbsp;kg/cm2G</td><td></td>
			...
			<table id="pbasis2">
				...
				<tbody>
					<tr>
						...
						<td>Operating Press</td><td><input type="number" name="op2" class="pspec2" value="${pvo1.op2}" onkeyup="rev_go(this.form)"></td><td>m</td>
					</tr>
					<tr>
						<td>Control Valve</td>
						<td>
							<input type="radio" id="Inlet"name="cvalve" value="Exist" onclick="rev_go(this.form)" checked> 
							<label for="Exist">Exist</label>
							<input type="radio" id="Outlet" name="cvalve" value="New" onclick="rev_go(this.form)">
							<label for="New">New</label>						
						</td>
						<td></td>
						<td>- Item.No</td><td><input type="text" name="citem" class="pspec2" value="${pvo1.citem}" onkeyup="rev_go(this.form)"></td><td>kg/cm2G</td>
					</tr>
					<tr>
						<td colspan="3"></td>
						<td>- Press Drop</td>
						<td><input type="number" name="cvdp" class="pspec2" <c:if test="${pvo1.cvalve eq 'New'}"> readonly </c:if>
							<c:if test="${pvo1.cvalve eq 'Exist'}"> onkeyup='rev_go(this.form)' </c:if>> </td>
				...
				<tbody>
					<tr><td>Line.No</td><td><input type="button" value="add" onclick="plineadd_go(this.form)" style="width:75px; font-size:18px; margin:inherit;"></td>
						<c:forEach var="k" items="${pslist}">  <!-- 1 -->
							<td><input type="text" name="lineno1" value="${k.pin}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>
					</tr>
					<tr><td>Pressure (In)</td><td>kg/cm2</td>  <!-- 2 -->
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="pin" value="${k.pin}" onkeyup="rev_go(this.form)"></td>
						</c:forEach>
					</tr>
					<tr><td>Pressure (out)</td><td>kg/cm2</td>  <!-- 3 -->
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="pout" value="${k.pout}" onkeyup="rev_go(this.form)"></td>
						</c:forEach>					
					</tr>
					<tr><td>Temperature</td><td>C</td>  <!-- 4 -->
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="temp" value="${k.temp}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td>Density</td><td>kg/m3</td>  <!-- 5 -->
						<c:forEach var="k" items="${pslist}">
							<td> <input type="number" name="den" value="${k.den}" onkeyup="rev_go(this.form)" >	</td>							
						</c:forEach>
					</tr>
					<tr><td>Viscosity</td><td>cP</td> 	 <!-- 6 -->
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="vis" value="${k.vis}" onkeyup="rev_go(this.form)" ></td>				
						</c:forEach>					
					</tr>
					<tr><td>Flow rate</td><td>kg/hr</td>  <!-- 7 -->
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="flow" value="${k.flow}" onkeyup="rev_go(this.form)" ></td>						
						</c:forEach>				
					</tr>
					<tr><td>Over Design</td><td>%</td>  	<!-- 8 -->
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="per" value="${k.per}" onkeyup="rev_go(this.form)" >	</td>					
						</c:forEach>					
					</tr>
					<tr><td>Complex factor</td><td></td>	<!-- 9 -->
						<c:forEach var="k" items="${pslist}">
							<td>			
								<select name="Fitting" id="combo1" onchange="rev_go(this.form)">
					...
					<tr><td>Line Size</td><td></td> 	<!-- 10 -->
						<c:forEach var="k" items="${pslist}">
							...
							<!-- 리스트를 따로 만들어서 For문 처리  -->
								<select name="dout" id="combo1" onchange="rev_go(this.form)">
					...
					<tr><td>Schedule or Class</td><td></td>
						<c:forEach var="k" items="${pslist}">
							<td>
								<select name="schd" id="combo1" onchange="rev_go(this.form)">
					...
					<tr><td>Length of Pipe</td><td>m</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="plen" value="${k.plen}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td>Wall Roughness</td><td>m</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="wall" value="${k.wall}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td>Elevation Change</td><td>m</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elchange" value="${k.elchange}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					...
					<tr><td style="position: relative; left:10px">- Threaded 
						...
						<td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_1" value="${k.elbow90_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>							
					</tr>
					<tr><td style="position: relative; left:127px">Long</td><td>(R/D=1.5)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_2" value="${k.elbow90_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					<tr>
					<tr><td style="position: relative; left:10px">- Flanged 
						...
						<td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_3" value="${k.elbow90_3}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>							
					</tr>
					<tr><td style="position: relative; left:127px">Long</td><td>(R/D=2)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_4" value="${k.elbow90_4}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td style="position: relative; left:127px">Long</td><td>(R/D=4)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_5" value="${k.elbow90_5}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td style="position: relative; left:127px">Long</td><td>(R/D=6)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_6" value="${k.elbow90_6}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td style="position: relative; left:10px">- Welded
						...
						<td> weld 90</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_7" value="${k.elbow90_7}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td style="position: relative; left:10px"><span style="position: relative; left:170px">2</span></td>
						<td>weld 45</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_8" value="${k.elbow90_8}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td style="position: relative; left:10px"><span style="position: relative; left:170px">3</span></td>
						<td>weld 30</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow90_9" value="${k.elbow90_9}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					...
					<tr><td style="position: relative; left:10px">- Threaded 
						...
						<td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow45_1" value="${k.elbow45_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td style="position: relative; left:127px">Long</td><td>(R/D=1.5)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="elbow45_2" value="${k.elbow45_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					<tr>
					<tr><td>180 Bend</td><td></td><td colspan="${pnum + 1}"></td></tr>		
					<tr><td style="position: relative; left:10px">- Threaded</td><td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="bend_1" value="${k.bend_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td style="position: relative; left:10px">- Flanged</td><td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="bend_2" value="${k.bend_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td style="position: relative; left:10px">- All types</td><td>(R/D=1.5)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="bend_3" value="${k.bend_3}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td colspan="2">Tee (branch as Elbow)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_1" value="${k.tee_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td style="position: relative; left:10px">- Threaded</td><td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_2 value="${k.tee_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td style="position: relative; left:10px">- Threaded</td><td>(R/D=1.5)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_3" value="${k.tee_3}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td style="position: relative; left:10px">- Flanged</td><td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_4" value="${k.tee_4}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					<tr>
					<tr><td colspan="2" style="position: relative; left:10px">- Stub-in branch</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_5" value="${k.tee_5}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					<tr>
					<tr><td colspan="2">Tee (Run-Through)</td></tr>
					<tr><td style="position: relative; left:10px">- Threaded</td><td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_6" value="${k.tee_6}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td style="position: relative; left:10px">- Flanged</td><td>(R/D=1)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_7" value="${k.tee_7}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					<tr>
					<tr><td colspan="2" style="position: relative; left:10px">- Stub-in branch</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="tee_8" value="${k.tee_8}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					<tr>
					<tr><td>Valve</td><td></td></tr>
					<tr><td style="position: relative; left:10px">- Gate valve</td><td></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="gtvalve" value="${k.gtvalve}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td style="position: relative; left:10px">- Globe valve</td><td></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="gbvalve" value="${k.gbvalve}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td style="position: relative; left:10px">- Ball valve</td><td></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="bvalve" value="${k.bvalve}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td style="position: relative; left:10px">- Check valve</td><td>(Swing)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="cvalve_1" value="${k.cvalve_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td></td><td>(Lift)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="cvalve_2" value="${k.cvalve_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>
					</tr>
					
					<tr><td style="position: relative; left:10px">- Angle valve</td><td>(45)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="avalve_1" value="${k.avalve_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td></td><td>(90)</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="avalve_2" value="${k.avalve_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td colspan="2" style="position: relative; left:10px;">- Plug valve
						<span style="position: relative; left:10px">(branch flow)</span></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="pvalve_1" value="${k.pvalve_1}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td colspan="2" style="position: relative; left:10px;">
						<span style="position: relative; left:100px">(straight flow)</span></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="pvalve_2" value="${k.pvalve_2}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>						
					</tr>
					<tr><td colspan="2" style="position: relative; left:10px;">
						<span style="position: relative; left:100px">(three-way)</span></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="pvalve_3" value="${k.pvalve_3}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td colspan="2" style="position: relative; left:10px;">- Diaphragm valve</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="dvalve" value="${k.dvalve}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td colspan="2" style="position: relative; left:10px">Reducer
						<span style="position: relative; left:65px">Diameter</span></td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="redd" value="${k.redd}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>					
					</tr>
					<tr><td colspan="2"><span style="position: relative; left:100px">theta</td>
						<c:forEach var="k" items="${pslist}">
							<td><input type="number" name="redth" value="${k.redth}" onkeyup="rev_go(this.form)" ></td>
						</c:forEach>				
					</tr>
					<tr><td colspan="2" style="position: relative; left:10px">Expander
						...
						<c:forEach var="k" items="${pslist}">
							<td>
								<input type="number" name="expd" value="${k.expd}" onkeyup="rev_go(this.form)" >
							</td>
						</c:forEach>				
					</tr>
					<tr><td colspan="2"><span style="position: relative; left:100px">theta</span></td>
						<c:forEach var="k" items="${pslist}">
							<td>
								<input type="number" name="expth" value="${k.expth}" onkeyup="rev_go(this.form)" >
							</td>
						</c:forEach>				
					<tr>
				</tbody>
